    ...
    <Link href={href} _hover={{ textDecoration: 'none' }} {...rest}>
      <HStack spacing={{ base: 1, md: 2 }} align="center">
        ...
        <Box lineHeight={1} color="gray.800" display={{ base: 'block', md: 'flex' }} alignItems="center">
          <Text as="span" fontWeight="600" fontSize={{ base: 'sm', md: 'md' }} display={{ base: 'block', md: 'inline' }} mr={{ base: 0, md: 2 }}>
            DATA
          </Text>
          <Text as="span" fontWeight="800" fontSize={{ base: 'md', md: 'xl' }} display={{ base: 'block', md: 'inline' }} color="orange.500" letterSpacing="wide">
            PROXY
          </Text>
        </Box>
      </HStack>
